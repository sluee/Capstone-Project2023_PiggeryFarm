        ...
        <template #header >
            <div class="flex justify-between">
                ...
                <div class="flex">
                    ...
                    <a :href="route('inventory.pdf')" class="flex  mb-2 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3 " target="blank">
                            ...
                            <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="inv in inventory" :key="inv.id">
                                ...
                                <td class="py-3 px-6 text-center whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <p class="font-medium">{{ inv.stock_out }}</p>
                                    </div>
                                </td>    
                                <td class="py-3 px-6 text-center whitespace-nowrap">
                                    <div class="flex items-center">
