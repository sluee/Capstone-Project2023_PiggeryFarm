    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">List of Feeds</h2>
                    ...
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light" >
                            <tr v-if="feeds.data.length === 0">
                                <td colspan="10" class="text-center text-lg  text-gray-400 py-6">No feeds record available</td>
                            </tr>
                            <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="feed in feeds.data" :key="feed.id">
                                ...
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <p class="font-medium">{{ feed.categories.name }}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
