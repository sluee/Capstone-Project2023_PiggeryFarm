    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">List of Labors</h2>
                ...
                <div class="flex">
                    ...
                    <!-- <Link class="button1 mb-2 py-2 px-3 bg-blue-300 shadow border-gray-300 border hover:bg-blue-400 rounded mr-3" as="button" href="/labors/create">Create Labor</Link> -->
                    <a :href="route('labors.pdf')" class="flex  mb-2 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3 " target="blank">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <Link :href="'/labors/' + labor.id" title="show">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110" v-if="labor.remarks==='Waiting for results'">
                                            <Link :href="'/labors/edit/'+labor.id" title="edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                </svg>
                                            </Link>
                                        </div>
                                        <!-- <div class="w-4 mr-2 transform hover:text-red-500 hover:scale-110" v-if="labor.remarks==='Waiting for results'">
                                            <a href="/delete">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
