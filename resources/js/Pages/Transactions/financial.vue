<script setup>
   ...
   const crumbs = [
    ...
    const formattedTransactionDate = computed(() => {
      ...
      const options = { year: 'numeric', month: 'long'  }; // You can customize the formatting options

      return new Intl.DateTimeFormat('en-US', options).format(transactionDate);
    });
    ...
    <SideBarLayout>
        <template #header>
            <div class="flex justify-between">
                <div>
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-1">View Financial Liquidation</h2>
                    <!-- <Breadcrumb :crumbs="crumbs"  /> -->
                </div>
                <div class="flex justify-between" v-if="transaction">
                    <a :href="'/transactions/pdf/'+transaction.id" class="flex  py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3 " target="blank">
        ...
        <div class="px-2 mt-5">
                        ...
                        <div class="  mb-7">
                            <div class="flex justify-center mb-2">
                                ...
                                <div class=" text-sm">
                                    ...
                                    <h3 class="font-bold text-slate-700 text-center">Financial Liquidation | {{ formattedTransactionDate }}</h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="w-full table-auto">
                                ...
                                <tbody>
                                    <tr v-for="part in transaction.financialItems" :key="part.id">
                                        ...
                                        <td class="py-2 px-2">
                                            <input v-model="part.debit" type="number" step="0.01" class="w-full border border-gray-300 p-2" readonly>
                                        </td>
                                        <td class="py-2 px-2">
                                            <input v-model="part.credit" type="number" step="0.01" class="w-full border border-gray-300 p-2" readonly>
                                        </td>
                                        <td class="py-2 px-2">
            ...
            <div v-else>
                <p class="text-center text-xl font-bold text-gray-900 py-6">No Financial Liquidation yet.</p>
            </div>
