        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <template v-if="sows.data&& sows.data.length > 0">
                        <table class="min-w-max w-full table-auto">
                            ...
                            <tbody class="text-gray-600 text-sm font-light" >
                                ...
                                <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="sow in sows.data" :key="sow.id">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <span class=" py-1 px-3 rounded-full text-xs">{{formattedDate (sow.date_arrived) }}</span>
                                    </td>
                    ...
                    <template v-else>
                        <p class="text-center font-bold text-gray-900 py-6">No sow available</p>
                    </template> 
