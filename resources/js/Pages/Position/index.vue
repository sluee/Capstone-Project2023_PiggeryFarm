    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">List of Positions</h2>
                    ...
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light" >
                            <tr v-if="positions.data.length === 0">
                                <td colspan="10" class="text-center text-lg  text-gray-400 py-6">No position record available</td>
                            </tr>
