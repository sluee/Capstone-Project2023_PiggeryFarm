    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">List of Customers</h2>
                            ...
                            <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="customer in customers.data" :key="customer.id">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <!-- <a :href="'/customers/' + customer.id" title="show" class="flex  mb-2 py-2 px-3 bg-blue-300 shadow border-blue-300 border hover:bg-blue-400 rounded mr-3 ">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="black" class="w-4 h-5 ">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                                            <a :href="'/customers/' + customer.id" title="show customer">
                                        ...
                                        <!-- <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                                            ...
                                            <a :href="'/customers/' + customer.id" title="show">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                </svg>
