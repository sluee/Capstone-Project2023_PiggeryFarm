    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                ...
                <div class="flex">
                    <Link class="button1 mb-2 py-2 px-3 bg-blue-300 shadow border-gray-300 border hover:bg-blue-400 rounded mr-3" as="button" href="/cashAdvance/create">Create Cash Advance</Link>
