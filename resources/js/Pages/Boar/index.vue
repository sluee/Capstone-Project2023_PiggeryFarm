    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                ...
                <div class="flex">
                    <Link class="button1 mb-2 py-2 px-3 bg-blue-300 shadow border-gray-300 border hover:bg-blue-400 rounded mr-3" as="button" href="/boars/create">Create Boar</Link>
                    <a :href="route('boars.pdf')" class="flex  mb-2 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3 " target="blank">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="boar in boars.data" :key="boar.id">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <p class="font-medium">{{ boar.id }}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <p class="font-medium">{{ boar.boar_no }}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <p class="font-medium">{{ boar.breed }}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <p class="font-medium">{{ boar.location}}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                ...
                                <td class="py-3 px-4 text-center">
                                    <div class="flex items-center justify-center mb-2">
                                        <span v-if="boar.status == 1" class="remarks-cell py-1 px-3 rounded-full text-xs bg-green-200 text-green-600">Active</span>
                ...
                <Modal :show="showConfirm" @close="closeModal">
                    ...
                    <Pagination v-if="boars.data.length >0" :links="boars.links" class="mt-6 flex justify-center"/>
            </div>
        </div>
