    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                ...
                <div class="flex">
                    <a :href="route('weanings.pdf')" class="flex  mb-2 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3 " target="blank">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <Link :href="'/weaning/' + wean.id" title="show">
