                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">Feeds Rate</th>
                                <th class="py-3 px-6 text-left">Total Amount</th>
                                <th class="py-3 px-6 text-center">Actions</th>
                            </tr>
                        </thead>
                        <tbody class="text-gray-600 text-sm font-light" >
                            <tr v-if="feedsPurchase.data.length === 0">
                                <td colspan="10" class="text-center text-lg  text-gray-400 py-6">No feeds purchase record available</td>
                            </tr>
                            <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="purchase in feedsPurchase.data" :key="purchase.id">
                                ...
                                <td class="py-3 px-5 text-left whitespace-nowrap">
                                    <div class="text-sm">
                                        <div class="font-medium ">{{formattedDate(purchase.date) }}</div>

                                    </div>
                                </td>
                                <td class="py-3 px-5 text-left whitespace-nowrap">
                                    <div class="text-sm">
                                        <div class="font-medium ">{{ purchase.feeds.categories.name }}</div>
                                        <div class="">{{ purchase.feeds.supplier.name }}</div>
                                    </div>
                                </td>
                                ...
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <p class="font-medium">{{ purchase.qty }} bags</p>
                                    </div>
                                </td>
                        ...
                        <div class="p-4 sm:p-10 text-center ">
                            ...
                            <form @submit.prevent="submit" >
                                ...
                                <div class="mt-6 flex justify-center gap-x-4">
                                    ...
                                    <PrimaryButton  @click="updateItem(purchase)">Update Item</PrimaryButton>
                                </div>
                            </form>
                            </div>
                        </div>
