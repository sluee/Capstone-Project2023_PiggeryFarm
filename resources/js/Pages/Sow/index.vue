    ...
    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">List of Sows</h2>
                ...
                <div class="flex">
                    ...
                    <a :href="route('sows.pdf')" class="flex  mb-2 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3 " target="blank">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light" >
                            <tr v-if="sows.data.length === 0">
                                <td colspan="7" class="text-center text-lg  text-gray-400 py-6">No sow record available</td>
                            </tr>
                            <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="sow in sows.data" :key="sow.id">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">

                                        <p class="font-medium">{{ sow.id }}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <p class="font-medium">{{ sow.sow_no }}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <p class="font-medium">{{ sow.location}}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                                            <a href="#" @click="remove(sow)" class="btn" title="Delete Position">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <Modal :show="showConfirm" @close="closeModal">
                    <div class="p-4 sm:p-10 text-center overflow-y-auto">
                        ...
                        <p class="text-gray-500">
                            Are you sure you want like to delete this Sow?
                        </p>
...
let search = ref(props.filters.search);
    ...
    let selectedSowForDelete = null
    let deleteForm = useForm({});


    function remove(sow) {
        selectedSowForDelete = sow
        showConfirm.value = true;
    }

    function deletePos(){
        deleteForm.delete('/sows/' + selectedSowForDelete.id)
