<template>
    ...
    <SideBarLayout>
        <template #header>
            <div class="flex">
                <h2 class="flex-1 font-semibold text-xl text-gray-800 leading-tight">View Labor</h2>
                <Link class="button1 mb-2 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3" as="button" :href="'/labors/'">Back</Link>
            </div>
        </template>
                ...
                <div class="bg-white  shadow-lg sm:rounded-lg">
                    <div class="p-6 text-gray-900 flex">
                        ...
                        <div class="flex-1 ml-4 bg-">
                            <div class="flex">
                                <h3 class="text-2xl flex-1 ">Details of Labor</h3>

                            </div>
                            <hr>
                            <div class="mt-2" ><strong>Sow:</strong>  {{ labor.sow.sow_no }} </div>
                            <div class="mt-2" ><strong>Boar Breed:</strong>  {{ labor.boar.breed }} </div>
