<script setup>
    ...
    {
        name:  "Showing sales #"+ props.sale.id ,
        url: null,
        active: true,
    },
    ]
    ...
    <SideBarLayout>
        <template #header>
            <div class="flex justify-between">
                <div>
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">View Sales Invoice</h2>
                    <Breadcrumb :crumbs="crumbs" class="mb-4" />
                </div>
                <div class="flex">
                    <a :href="'/sales/pdf/'+sale.id" class="flex mb-4 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3 " target="blank">
