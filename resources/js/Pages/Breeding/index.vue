        ...
        <template #header >
            <div class="flex justify-between">
                ...
                <div class="flex">
                    ...
                    <Link class="button1 mb-2 py-2 px-3 bg-blue-300 shadow border-gray-300 border hover:bg-blue-400 rounded mr-3" as="button" href="/breedings/create">Create Breeding</Link>
                    <a :href="route('breeding.pdf')" class="flex  mb-2 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3 " target="blank">
                                ...
                                <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="breeding in breedings.data" :key="breeding.id">
                                    ...
                                    <td class="py-3 px-3 text-center">
                                        <div class="flex items-center justify-center">
                                            <p class="font-medium">{{ breeding.boar.boar_no }} | {{breeding.boar.breed}}</p>
                                        </div>
                                    </td>
                                    <td class="py-3 px-3 text-center">
                                        <div class="flex items-center justify-center">
                                    ...
                                    <td class="py-3 px-3 text-center">
                                        <span class="remarks-cell  py-1 px-3 rounded-full text-xs"
                                            :class="{
                                                ...
                                                'bg-green-300 text-green-800': breeding.remarks == 'Done',
                                    ...
                                    <td class="py-3 px-5 text-center">
                                        <div class="flex item-center justify-center">
                                            <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                                                <Link :href="'/breedings/' + breeding.id" title="show">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110" v-if="breeding.remarks== 'Waiting for results'">
                                                <Link :href="'/breedings/edit/'+breeding.id" title="edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-red-500 hover:scale-110"  v-if="breeding.remarks== 'Waiting for results'">
                                                <Link :href="'/breedings/delete/'+breeding.id" title="delete" >
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// function search(ev){
//     router.visit('/breedings/search/'+ ev.target.value);
