        ...
        <template #header >
            <div class="flex justify-between">
                ...
                <div class="flex">
                    ...
                    <a href="/breedings/pdf" class="flex  mb-2 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3 " target="blank">
