...
<template>
    ...
    <Head title="Financial Category" />

    <SideBarLayout>
        <template #header >
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">List of Financial Category</h2>
                <div style="position:relative">
                    <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-9 p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Particular here" @keydown.enter="search($event)">
                    ...
                    <div class=" pr-6">
                        ...
                        <form @submit.prevent="submit" >
                            <div class="px-4 py-5">
                                ...
                                <label class="font-semibold text-sm text-gray-600  block" for="particulars">Particulars</label>
                                <input type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full text-gray-600 "  v-model="form.particulars"/>
                                <div class="text-red-600" v-if="form.errors.particulars">{{ form.errors.particulars }}</div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            <table class="min-w-max w-full table-auto">
                                ...
                                <tbody class="text-gray-600 text-sm font-light" >
                                    ...
                                    <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="par in financial" :key="par.id">
                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                            <div class="flex items-center">

                                                <p class="font-medium">{{ par.id }}</p>
                                            </div>
                                        </td>
                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                            <div class="flex items-center">

                                                <p class="font-medium">{{ par.particulars }}</p>
                                            </div>
                                        </td>
